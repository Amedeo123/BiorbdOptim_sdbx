...
fig = plt.figure()
fig = plt.subplot(511)
plt.plot(range(24), err_q_ac[:-1], 'rx', label='err. mhe activation driven')
# plt.errorbar(range(24), err_q_ac[:-1], yerr=err_std_q_ac*2)
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_q_ac[-1], (len(Nmhe_ac)-1, 1)), 'r--',  label='err. full window activation driven')
plt.plot(err_q_ex[:-1], 'bx', label='err. mhe excitation driven')
# plt.errorbar(err_std_q_ex*2, 'b')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_q_ex[-1], (len(Nmhe_ac)-1, 1)), 'b--',  label='err. full window excitation driven')
...
fig = plt.subplot(512)
plt.plot(err_dq_ac[:-1], 'rx', label='err. mhe activation driven')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_dq_ac[-1], (len(Nmhe_ac)-1, 1)), 'r--',  label='err. full window activation driven')
plt.plot(err_dq_ex[:-1], 'bx', label='err. mhe excitation driven')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_dq_ex[-1], (len(Nmhe_ac)-1, 1)), 'b--',  label='err. full window excitation driven')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-3), (len(Nmhe_ac)-1, 1)), c='red', label = 'limit_err_1e-3')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-4), (len(Nmhe_ac)-1, 1)), c='purple', label = 'limit_err_1e-4')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-5), (len(Nmhe_ac)-1, 1)), 'k', label = 'limit_err_1e-5')
fig.set_xticks(range(len(Nmhe_ac)-1))
...
fig = plt.subplot(513)
plt.plot(err_muscles_ac[:-1], 'rx', label='err. mhe activation driven')
plt.plot(err_muscles_ex[:-1], 'bx', label='err. mhe excitation driven')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_muscles_ac[-1], (len(Nmhe_ac)-1, 1)), 'r--',  label='err. full window activation driven')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_muscles_ex[-1], (len(Nmhe_ac)-1, 1)), 'b--',  label='err. full window excitation driven')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-3), (len(Nmhe_ac)-1, 1)), c='red', label = 'limit_err_1e-3')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-4), (len(Nmhe_ac)-1, 1)), c='purple', label = 'limit_err_1e-4')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-5), (len(Nmhe_ac)-1, 1)), 'k', label = 'limit_err_1e-5')
fig.set_xticks(range(len(Nmhe_ac)-1))
...
fig = plt.subplot(514)
plt.plot(err_markers_ac[:-1], 'rx', label='err. mhe activation driven')
plt.plot(err_markers_ex[:-1], 'bx', label='err. mhe excitation driven')
plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(err_markers_ac[-1], (len(Nmhe_ac)-1, 1)), 'r--',  label='err. full window activation driven')
plt.plot(np.arange(len(Nmhe_ex)-1), np.tile(err_markers_ex[-1], (len(Nmhe_ac)-1, 1)), 'b--',  label='err. full window excitatiojn driven')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-3), (len(Nmhe_ac)-1, 1)), c='red', label = 'limit_err_1e-3')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-4), (len(Nmhe_ac)-1, 1)), c='purple', label = 'limit_err_1e-4')
# plt.plot(np.arange(len(Nmhe_ac)-1), np.tile(np.array(1e-5), (len(Nmhe_ac)-1, 1)), 'k', label = 'limit_err_1e-5')
fig.set_xticks(range(len(Nmhe_ac)-1))
